<template>
  <div
    class="ui-module-index-banner"
    :class="{
      'with-link': link
    }"
    flex="dir:top main:center cross:top"
  >
    <p class="ui-module-index-banner--title">{{title}}</p>
    <p class="ui-module-index-banner--sub-title">{{subTitle}}</p>
    <p v-if="link" class="ui-module-index-banner--link" @click="handleLinkClick">
      <span class="ui-module-index-banner--link-button">
        <ui-icon-fa name="link" />
        {{link}}
      </span>
    </p>
  </div>
...
<style lang="scss">
.ui-module-index-banner {
  .ui-module-index-banner--title {
    margin: 0px;
    padding: 0px;
    margin-left: -8px;
    font-size: 120px;
  ...
  .ui-module-index-banner--sub-title {
    margin: 0px;
    padding: 0px;
    font-size: 16px;
    color: #fff;
  }
  .ui-module-index-banner--link {
    margin: 0px;
    padding: 0px;
    margin-top: 10px;
    .ui-module-index-banner--link-button {
      font-size: 12px;
      color: #fff;
      padding: 4px 6px;
      border-radius: 2px;
